...
package com.example.wuhongjie.myapplication.util.widge;
...
public class Badge2View extends TextView {

    private boolean mHideOnNull = true;

    public Badge2View(Context context) {
        this(context, null);
    }

    public Badge2View(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public Badge2View(Context context, AttributeSet attrs, int defStyle) {
